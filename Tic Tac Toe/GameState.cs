...
namespace Tic_Tac_Toe
{
    public class GameState
    {
        ...
        // returns wether or not the player can mark a given square
        ...
        // when the mova has been made we have to switch current player
        ...
        // check if the given move won the game
